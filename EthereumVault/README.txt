...
EthereumVault - Lock funds with the hash of some secret data.  Unlock and release the funds by providing
                the secret (pre-image) used to derive the hash.  Storing ether in this contract is optional. 
                We can simply use it to verify the integrity of some underlying data, without exposing the underlying data 
